...
import { MonitoringPrometheus } from './type.Prometheus.js';
import rfc6902  from 'rfc6902';

const customApi = kc.makeApiClient(k8s.CustomObjectsApi);
export const mutations = {
    createMonitoringPrometheus: async (_parent, args: object) => {
        const spec = {};
        if (args['spec'] == undefined || args['name']==undefined) return null;
        if (args['spec']['additionalAlertManagerConfigs'] !== undefined && typeof args['spec']['additionalAlertManagerConfigs'] == 'object') spec['additionalAlertManagerConfigs'] = args['spec']['additionalAlertManagerConfigs'];
        if (args['spec']['additionalAlertRelabelConfigs'] !== undefined && typeof args['spec']['additionalAlertRelabelConfigs'] == 'object') spec['additionalAlertRelabelConfigs'] = args['spec']['additionalAlertRelabelConfigs'];
        ...
        if (args['spec']['alerting'] !== undefined && typeof args['spec']['alerting'] == 'object') spec['alerting'] = args['spec']['alerting'];
        if (args['spec']['allowOverlappingBlocks'] !== undefined && typeof args['spec']['allowOverlappingBlocks'] == 'boolean') spec['allowOverlappingBlocks'] = args['spec']['allowOverlappingBlocks'];
        ...
        if (args['spec']['disableCompaction'] !== undefined && typeof args['spec']['disableCompaction'] == 'boolean') spec['disableCompaction'] = args['spec']['disableCompaction'];
        if (args['spec']['enableAdminAPI'] !== undefined && typeof args['spec']['enableAdminAPI'] == 'boolean') spec['enableAdminAPI'] = args['spec']['enableAdminAPI'];
        ...
        if (args['spec']['exemplars'] !== undefined && typeof args['spec']['exemplars'] == 'object') spec['exemplars'] = args['spec']['exemplars'];
        ...
        if (args['spec']['query'] !== undefined && typeof args['spec']['query'] == 'object') spec['query'] = args['spec']['query'];
        if (args['spec']['queryLogFile'] !== undefined && typeof args['spec']['queryLogFile'] == 'string') spec['queryLogFile'] = args['spec']['queryLogFile'];
        if (args['spec']['remoteRead'] !== undefined && Array.isArray(args['spec']['remoteRead'])) spec['remoteRead'] = args['spec']['remoteRead'];
        ...
        if (args['spec']['retentionSize'] !== undefined && typeof args['spec']['retentionSize'] == 'string') spec['retentionSize'] = args['spec']['retentionSize'];
        ...
        if (args['spec']['rules'] !== undefined && typeof args['spec']['rules'] == 'object') spec['rules'] = args['spec']['rules'];
        ...
        if (args['spec']['thanos'] !== undefined && typeof args['spec']['thanos'] == 'object') spec['thanos'] = args['spec']['thanos'];
        ...
        if (args['spec']['tsdb'] !== undefined && typeof args['spec']['tsdb'] == 'object') spec['tsdb'] = args['spec']['tsdb'];
    ...
    patchMonitoringPrometheus: async (_parent, args: object) => {
        const spec = {};
        if (args['spec'] == undefined || args['name']==undefined) return null;
        if (args['spec']['additionalAlertManagerConfigs'] !== undefined && typeof args['spec']['additionalAlertManagerConfigs'] == 'object') spec['additionalAlertManagerConfigs'] = args['spec']['additionalAlertManagerConfigs'];
        if (args['spec']['additionalAlertRelabelConfigs'] !== undefined && typeof args['spec']['additionalAlertRelabelConfigs'] == 'object') spec['additionalAlertRelabelConfigs'] = args['spec']['additionalAlertRelabelConfigs'];
        ...
        try {
            const resGet = await customApi.getNamespacedCustomObject('monitoring.coreos.com','v1',args['namespace'],'prometheuses', args['name'])
            const extGet = resGet.body as MonitoringPrometheus
    ...
    deleteMonitoringPrometheus: async (_parent, args: object) => {
    try {
