...
const { result, loading, onResult, onError } = useQuery(redisRedisQuery, {"namespace": navigation.currentNamespace, "name": navigation.currentItem }, { pollInterval: 500 });onError(onErrorHandler); onResult(res => {onNotRedisFound(res);viewerUpdate(res, res.data.redisRedis.metadata.obj)});
