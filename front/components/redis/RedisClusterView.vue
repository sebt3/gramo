...
const { viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotRedisClusterFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useRedisCluster();setNamespacedItemFromRoute();
