...
import redisClusterNew from '@/queries/redis/RedisClusterNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'redisclusters.redis.redis.opstreelabs.in'});
