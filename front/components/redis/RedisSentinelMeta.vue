...
import { ref, useRedisSentinel } from '../../libs/redis/RedisSentinel.js'
const { actionNew, toEdit, actionDelete } = useRedisSentinel();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'redisRedisSentinelTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'redisRedisSentinelTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'redisRedisSentinelView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
