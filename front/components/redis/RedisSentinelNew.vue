...
import redisSentinelNew from '@/queries/redis/RedisSentinelNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'redissentinels.redis.redis.opstreelabs.in'});
