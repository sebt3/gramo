...
import redisReplicationNew from '@/queries/redis/RedisReplicationNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'redisreplications.redis.redis.opstreelabs.in'});
