...
import { ref, useRedis } from '../../libs/redis/Redis.js'
const { actionNew, toEdit, actionDelete } = useRedis();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'redisRedisTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'redisRedisTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'redisRedisView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
