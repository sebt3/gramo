...
onError(onErrorHandler);onResult(res => {onNotMySQLBackupFound(res);editor.value.updateFromQuery(res, res.loading?{}:{spec: res.data.mysqlMySQLBackup.metadata.obj.spec})});onPatchMySQLBackup(patchDone);onPatchError(patchError);
</script>
<template>
  ...
  <q-form @submit="onSubmit" class="q-gutter-md q-pt-sm q-ml-sm">
    <q-card bordered v-if="!loading && editor.ready && result.mysqlMySQLBackup!=null" class="q-ma-sm">
