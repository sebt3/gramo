...
import mySQLBackupNew from '@/queries/mysql/MySQLBackupNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'mysqlbackups.mysql.oracle.com'});
