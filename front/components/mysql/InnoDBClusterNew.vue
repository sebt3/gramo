...
import innoDBClusterNew from '@/queries/mysql/InnoDBClusterNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'innodbclusters.mysql.oracle.com'});
