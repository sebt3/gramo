...
import { ref, useNetworkPolicy } from '../../libs/projectcalico/NetworkPolicy.js'
const { actionNew, toEdit, actionDelete } = useNetworkPolicy();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'projectcalicoNetworkPolicyTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'projectcalicoNetworkPolicyTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'projectcalicoNetworkPolicyView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
