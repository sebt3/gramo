...
import { ref, useClusterInformation } from '../../libs/projectcalico/ClusterInformation.js'
const { actionNew, toEdit, actionDelete } = useClusterInformation();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'projectcalicoClusterInformationTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'projectcalicoClusterInformationTable', params: {  } }"
        :nameTo="{ name: 'projectcalicoClusterInformationView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
