...
import { useKubeControllersConfiguration, getProperties, KubeControllersConfigurationDefinition } from '../../libs/projectcalico/KubeControllersConfiguration.js'
const { onlyReadProperties, viewer, viewerUpdate, setItemFromRoute } = useKubeControllersConfiguration();setItemFromRoute();
