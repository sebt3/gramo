...
const { result, loading, onResult, onError } = useQuery(projectcalicoGlobalNetworkSetQuery, { "name": navigation.currentItem }, { pollInterval: 500 });onError(onErrorHandler); onResult(res => {onNotGlobalNetworkSetFound(res);viewerUpdate(res, res.data.projectcalicoGlobalNetworkSet.metadata.obj)});
