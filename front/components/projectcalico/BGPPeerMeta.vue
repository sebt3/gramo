...
import { ref, useBGPPeer } from '../../libs/projectcalico/BGPPeer.js'
const { actionNew, toEdit, actionDelete } = useBGPPeer();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'projectcalicoBGPPeerTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'projectcalicoBGPPeerTable', params: {  } }"
        :nameTo="{ name: 'projectcalicoBGPPeerView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
