...
import iPAMConfigNew from '@/queries/projectcalico/IPAMConfigNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'ipamconfigs.crd.projectcalico.org'});
