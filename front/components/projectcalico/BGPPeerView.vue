...
const { viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotBGPPeerFound, navigation, setItemFromRoute, toEdit, actionDelete } = useBGPPeer();setItemFromRoute();
