...
import { ref, useGlobalNetworkPolicy } from '../../libs/projectcalico/GlobalNetworkPolicy.js'
const { actionNew, toEdit, actionDelete } = useGlobalNetworkPolicy();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'projectcalicoGlobalNetworkPolicyTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'projectcalicoGlobalNetworkPolicyTable', params: {  } }"
        :nameTo="{ name: 'projectcalicoGlobalNetworkPolicyView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
