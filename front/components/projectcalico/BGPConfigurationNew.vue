...
import bGPConfigurationNew from '@/queries/projectcalico/BGPConfigurationNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'bgpconfigurations.crd.projectcalico.org'});
