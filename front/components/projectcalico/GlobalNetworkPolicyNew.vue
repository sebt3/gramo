...
import globalNetworkPolicyNew from '@/queries/projectcalico/GlobalNetworkPolicyNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'globalnetworkpolicies.crd.projectcalico.org'});
