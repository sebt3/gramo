...
import networkSetNew from '@/queries/projectcalico/NetworkSetNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'networksets.crd.projectcalico.org'});
