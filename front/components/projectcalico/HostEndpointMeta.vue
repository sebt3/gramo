...
import { ref, useHostEndpoint } from '../../libs/projectcalico/HostEndpoint.js'
const { actionNew, toEdit, actionDelete } = useHostEndpoint();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'projectcalicoHostEndpointTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'projectcalicoHostEndpointTable', params: {  } }"
        :nameTo="{ name: 'projectcalicoHostEndpointView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
