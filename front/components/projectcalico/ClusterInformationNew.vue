...
import clusterInformationNew from '@/queries/projectcalico/ClusterInformationNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'clusterinformations.crd.projectcalico.org'});
