...
import { ref, useIPAMBlock } from '../../libs/projectcalico/IPAMBlock.js'
const { actionNew, toEdit, actionDelete } = useIPAMBlock();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'projectcalicoIPAMBlockTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'projectcalicoIPAMBlockTable', params: {  } }"
        :nameTo="{ name: 'projectcalicoIPAMBlockView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
