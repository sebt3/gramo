...
import iPAMBlockNew from '@/queries/projectcalico/IPAMBlockNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'ipamblocks.crd.projectcalico.org'});
