...
import iPReservationNew from '@/queries/projectcalico/IPReservationNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'ipreservations.crd.projectcalico.org'});
