...
import iPAMHandleNew from '@/queries/projectcalico/IPAMHandleNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'ipamhandles.crd.projectcalico.org'});
