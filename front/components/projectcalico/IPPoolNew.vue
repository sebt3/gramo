...
import iPPoolNew from '@/queries/projectcalico/IPPoolNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'ippools.crd.projectcalico.org'});
