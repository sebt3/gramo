...
import bGPPeerNew from '@/queries/projectcalico/BGPPeerNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'bgppeers.crd.projectcalico.org'});
