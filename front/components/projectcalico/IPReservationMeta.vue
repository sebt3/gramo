...
import { ref, useIPReservation } from '../../libs/projectcalico/IPReservation.js'
const { actionNew, toEdit, actionDelete } = useIPReservation();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'projectcalicoIPReservationTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'projectcalicoIPReservationTable', params: {  } }"
        :nameTo="{ name: 'projectcalicoIPReservationView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
