...
import globalNetworkSetNew from '@/queries/projectcalico/GlobalNetworkSetNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'globalnetworksets.crd.projectcalico.org'});
