...
import networkPolicyNew from '@/queries/projectcalico/NetworkPolicyNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'networkpolicies.crd.projectcalico.org'});
