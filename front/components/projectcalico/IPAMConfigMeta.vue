...
import { ref, useIPAMConfig } from '../../libs/projectcalico/IPAMConfig.js'
const { actionNew, toEdit, actionDelete } = useIPAMConfig();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'projectcalicoIPAMConfigTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'projectcalicoIPAMConfigTable', params: {  } }"
        :nameTo="{ name: 'projectcalicoIPAMConfigView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
