...
const { viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotNetworkSetFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useNetworkSet();setNamespacedItemFromRoute();
