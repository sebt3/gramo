...
const { editor, viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotHostEndpointFound, navigation, setItemFromRoute, toEdit, actionDelete } = useHostEndpoint();setItemFromRoute();
