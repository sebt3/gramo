...
import { ref, useIPAMHandle } from '../../libs/projectcalico/IPAMHandle.js'
const { actionNew, toEdit, actionDelete } = useIPAMHandle();
const to=ref({})
...
<template>
  <q-card bordered class="q-ma-sm">
    <q-card-section class="bg-primary text-grey-4">
      <div class="text-h6 q-mt-none q-mb-none q-pt-none q-pb-none">IPAMHandle
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'projectcalicoIPAMHandleTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'projectcalicoIPAMHandleTable', params: {  } }"
        :nameTo="{ name: 'projectcalicoIPAMHandleView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
