...
import { ref, useBlockAffinity } from '../../libs/projectcalico/BlockAffinity.js'
const { actionNew, toEdit, actionDelete } = useBlockAffinity();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'projectcalicoBlockAffinityTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'projectcalicoBlockAffinityTable', params: {  } }"
        :nameTo="{ name: 'projectcalicoBlockAffinityView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
