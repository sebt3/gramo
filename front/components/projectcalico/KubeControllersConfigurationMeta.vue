...
import { ref, useKubeControllersConfiguration } from '../../libs/projectcalico/KubeControllersConfiguration.js'
const { actionNew, toEdit, actionDelete } = useKubeControllersConfiguration();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'projectcalicoKubeControllersConfigurationTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'projectcalicoKubeControllersConfigurationTable', params: {  } }"
        :nameTo="{ name: 'projectcalicoKubeControllersConfigurationView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
