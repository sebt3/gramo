...
const { viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotFelixConfigurationFound, navigation, setItemFromRoute, toEdit, actionDelete } = useFelixConfiguration();setItemFromRoute();
