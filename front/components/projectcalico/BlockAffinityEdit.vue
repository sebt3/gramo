...
const data = ref({});
const { patchDone, patchError, notifyWorking, onNotBlockAffinityFound, setItemFromRoute, navigation, onErrorHandler } = useBlockAffinity();setItemFromRoute();
...
onError(onErrorHandler);onResult(onNotBlockAffinityFound);onPatchBlockAffinity(patchDone);onPatchError(patchError);
</script>
<template>
