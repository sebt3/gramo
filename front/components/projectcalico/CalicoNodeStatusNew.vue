...
import calicoNodeStatusNew from '@/queries/projectcalico/CalicoNodeStatusNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'caliconodestatuses.crd.projectcalico.org'});
