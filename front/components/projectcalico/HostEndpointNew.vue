...
import hostEndpointNew from '@/queries/projectcalico/HostEndpointNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'hostendpoints.crd.projectcalico.org'});
