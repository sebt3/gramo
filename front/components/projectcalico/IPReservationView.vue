...
import { useIPReservation, getProperties, IPReservationDefinition } from '../../libs/projectcalico/IPReservation.js'
const { onlyReadProperties, viewer, viewerUpdate, setItemFromRoute } = useIPReservation();setItemFromRoute();
