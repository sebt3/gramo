...
import { ref, useJaeger } from '../../libs/jaegertracing/Jaeger.js'
const { actionNew, toEdit, actionDelete } = useJaeger();
const to=ref({})
...
<template>
  <q-card bordered class="q-ma-sm">
    <q-card-section class="bg-primary text-grey-4">
      <div class="text-h6 q-mt-none q-mb-none q-pt-none q-pb-none">Jaeger
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'jaegertracingJaegerTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'jaegertracingJaegerTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'jaegertracingJaegerView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
