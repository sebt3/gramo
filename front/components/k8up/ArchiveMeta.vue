...
import { ref, useArchive } from '../../libs/k8up/Archive.js'
const { actionNew, toEdit, actionDelete } = useArchive();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'k8upArchiveTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'k8upArchiveTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'k8upArchiveView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
