...
import { ref, useRestore, RestoreColumns, RestoreAllColumns } from '../../libs/k8up/Restore.js'
...
<template>
  <q-card class="q-ma-sm" bordered>
    <TableHeader title="k8up Restores" :usecreate="useAction" :userefresh="useAction" itemtype='k8up Restore' v-model:model-filter="filter" @refresh="$emit('refresh')" @create="actionNew(navigation.currentNamespace.value)" />
