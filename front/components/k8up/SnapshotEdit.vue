...
const data = ref({});
const { patchDone, patchError, notifyWorking, onNotSnapshotFound, setNamespacedItemFromRoute, navigation, onErrorHandler } = useSnapshot();setNamespacedItemFromRoute();
...
onError(onErrorHandler);onResult(onNotSnapshotFound);onPatchSnapshot(patchDone);onPatchError(patchError);
</script>
<template>
