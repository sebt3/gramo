...
const { result, loading, onResult, onError } = useQuery(k8upRestoreQuery, {"namespace": navigation.currentNamespace, "name": navigation.currentItem }, { pollInterval: 500 });onError(onErrorHandler); onResult(res => {onNotRestoreFound(res);viewerUpdate(res, res.data.k8upRestore.metadata.obj)});
