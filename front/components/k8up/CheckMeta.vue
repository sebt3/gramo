...
import { ref, useCheck } from '../../libs/k8up/Check.js'
const { actionNew, toEdit, actionDelete } = useCheck();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'k8upCheckTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'k8upCheckTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'k8upCheckView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
