...
const { editor, viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotPreBackupPodFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = usePreBackupPod();setNamespacedItemFromRoute();
