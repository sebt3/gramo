...
const { editor, viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotScheduleFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useSchedule();setNamespacedItemFromRoute();
