...
import stringSecretNew from '@/queries/secretgenerator/StringSecretNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'stringsecrets.secretgenerator.mittwald.de'});
