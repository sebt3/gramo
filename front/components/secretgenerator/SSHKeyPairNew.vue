...
import sSHKeyPairNew from '@/queries/secretgenerator/SSHKeyPairNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'sshkeypairs.secretgenerator.mittwald.de'});
