...
import basicAuthNew from '@/queries/secretgenerator/BasicAuthNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'basicauths.secretgenerator.mittwald.de'});
