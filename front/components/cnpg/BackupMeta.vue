...
import { ref, useBackup } from '../../libs/cnpg/Backup.js'
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'cnpgBackupTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'cnpgBackupTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'cnpgBackupView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
