...
import { ref, usePooler } from '../../libs/cnpg/Pooler.js'
const { actionNew, toEdit, actionDelete } = usePooler();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'cnpgPoolerTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'cnpgPoolerTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'cnpgPoolerView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
