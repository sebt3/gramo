...
import prometheusNew from '@/queries/monitoring/PrometheusNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'prometheuses.monitoring.coreos.com'});
