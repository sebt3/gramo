...
const { viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotPodMonitorFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = usePodMonitor();setNamespacedItemFromRoute();
