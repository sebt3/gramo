...
const { result, loading, onResult, onError } = useQuery(monitoringPodMonitorQuery, {"namespace": navigation.currentNamespace, "name": navigation.currentItem }, { pollInterval: 500 });onError(onErrorHandler); onResult(res => {onNotPodMonitorFound(res);viewerUpdate(res, res.data.monitoringPodMonitor.metadata.obj)});
