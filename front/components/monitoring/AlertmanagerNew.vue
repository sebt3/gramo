...
import alertmanagerNew from '@/queries/monitoring/AlertmanagerNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'alertmanagers.monitoring.coreos.com'});
