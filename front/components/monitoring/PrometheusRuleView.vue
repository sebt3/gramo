...
const { viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotPrometheusRuleFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = usePrometheusRule();setNamespacedItemFromRoute();
