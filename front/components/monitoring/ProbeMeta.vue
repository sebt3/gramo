...
import { ref, useProbe } from '../../libs/monitoring/Probe.js'
const { actionNew, toEdit, actionDelete } = useProbe();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'monitoringProbeTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'monitoringProbeTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'monitoringProbeView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
