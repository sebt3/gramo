...
import thanosRulerNew from '@/queries/monitoring/ThanosRulerNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'thanosrulers.monitoring.coreos.com'});
