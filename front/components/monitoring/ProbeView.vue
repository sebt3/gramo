...
const { onErrorHandler, notifySuccess, notifyError, onNotProbeFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useProbe();setNamespacedItemFromRoute();
const { result, loading, onResult, onError } = useQuery(monitoringProbeQuery, {"namespace": navigation.currentNamespace, "name": navigation.currentItem }, { pollInterval: 500 });onError(onErrorHandler); onResult(onNotProbeFound);
