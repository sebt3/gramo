...
import prometheusRuleNew from '@/queries/monitoring/PrometheusRuleNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'prometheusrules.monitoring.coreos.com'});
