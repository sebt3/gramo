...
import serviceMonitorNew from '@/queries/monitoring/ServiceMonitorNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'servicemonitors.monitoring.coreos.com'});
