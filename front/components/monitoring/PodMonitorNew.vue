...
import podMonitorNew from '@/queries/monitoring/PodMonitorNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'podmonitors.monitoring.coreos.com'});
