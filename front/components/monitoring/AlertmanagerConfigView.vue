...
const { viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotAlertmanagerConfigFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useAlertmanagerConfig();setNamespacedItemFromRoute();
