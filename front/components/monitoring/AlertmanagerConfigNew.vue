...
import alertmanagerConfigNew from '@/queries/monitoring/AlertmanagerConfigNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'alertmanagerconfigs.monitoring.coreos.com'});
