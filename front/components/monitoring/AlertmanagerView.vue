...
const { viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotAlertmanagerFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useAlertmanager();setNamespacedItemFromRoute();
