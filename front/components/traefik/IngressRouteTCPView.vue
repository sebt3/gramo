...
import { useIngressRouteTCP, getProperties, IngressRouteTCPDefinition } from '../../libs/traefik/IngressRouteTCP.js'
const { onlyReadProperties, viewer, viewerUpdate, setNamespacedItemFromRoute } = useIngressRouteTCP();setNamespacedItemFromRoute();
