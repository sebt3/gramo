...
import { usepostgresql, getProperties, postgresqlDefinition } from '../../libs/zalando/postgresql.js'
const { onlyReadProperties, viewer, viewerUpdate, setNamespacedItemFromRoute } = usepostgresql();setNamespacedItemFromRoute();
