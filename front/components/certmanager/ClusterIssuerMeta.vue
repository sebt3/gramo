...
import { ref, useClusterIssuer } from '../../libs/certmanager/ClusterIssuer.js'
const { actionNew, toEdit, actionDelete } = useClusterIssuer();
const to=ref({})
...
<template>
  <q-card bordered class="q-ma-sm">
    <q-card-section class="bg-primary text-grey-4">
      <div class="text-h6 q-mt-none q-mb-none q-pt-none q-pb-none">ClusterIssuer
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'certmanagerClusterIssuerTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'certmanagerClusterIssuerTable', params: {  } }"
        :nameTo="{ name: 'certmanagerClusterIssuerView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
