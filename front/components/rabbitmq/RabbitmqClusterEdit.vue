...
const { onlyReadProperties, editor, setNamespacedItemFromRoute } = useRabbitmqCluster();setNamespacedItemFromRoute();
    ...
    <q-tab-panels v-model="editor.tab" animated>
      ...
      <q-tab-panel name="yaml">
          <MonacoEditor
            ...
            :properties="getProperties({properties: Object.fromEntries(Object.entries(RabbitmqClusterDefinition).filter(([n])=>!['metadata','status'].includes(n)))})"
            />
      </q-tab-panel>
    </q-tab-panels>
  </q-card>
