...
import rabbitmqClusterNew from '@/queries/rabbitmq/RabbitmqClusterNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'rabbitmqclusters.rabbitmq.com'});
