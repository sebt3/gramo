...
import { ref, useRabbitmqCluster } from '../../libs/rabbitmq/RabbitmqCluster.js'
const { actionNew, toEdit, actionDelete } = useRabbitmqCluster();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'rabbitmqRabbitmqClusterTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'rabbitmqRabbitmqClusterTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'rabbitmqRabbitmqClusterView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
