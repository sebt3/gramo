...
const { editor, viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotRabbitmqClusterFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useRabbitmqCluster();setNamespacedItemFromRoute();
