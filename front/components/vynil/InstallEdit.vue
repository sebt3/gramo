...
const { onlyReadProperties, editor, setNamespacedItemFromRoute } = useInstall();setNamespacedItemFromRoute();
    ...
    <q-tab-panels v-model="editor.tab" animated>
      ...
      <q-tab-panel name="yaml">
          <MonacoEditor
            ...
            :properties="getProperties({properties: Object.fromEntries(Object.entries(InstallDefinition).filter(([n])=>!['metadata','status'].includes(n)))})"
            />
      </q-tab-panel>
    </q-tab-panels>
  </q-card>
