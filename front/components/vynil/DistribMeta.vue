...
import { ref, useDistrib } from '../../libs/vynil/Distrib.js'
const { actionNew, toEdit, actionDelete } = useDistrib();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'vynilDistribTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'vynilDistribTable', params: {  } }"
        :nameTo="{ name: 'vynilDistribView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
