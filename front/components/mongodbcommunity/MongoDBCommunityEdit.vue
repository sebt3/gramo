...
onError(onErrorHandler);onResult(res => {onNotMongoDBCommunityFound(res);editor.value.updateFromQuery(res, res.loading?{}:{spec: res.data.mongodbcommunityMongoDBCommunity.metadata.obj.spec})});onPatchMongoDBCommunity(patchDone);onPatchError(patchError);
</script>
<template>
  ...
  <q-form @submit="onSubmit" class="q-gutter-md q-pt-sm q-ml-sm">
    <q-card bordered v-if="!loading && editor.ready && result.mongodbcommunityMongoDBCommunity!=null" class="q-ma-sm">
