...
import mongoDBCommunityNew from '@/queries/mongodbcommunity/MongoDBCommunityNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'mongodbcommunity.mongodbcommunity.mongodb.com'});
