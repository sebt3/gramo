...
import { ref, useHelmRelease } from '../../libs/fluxcd/HelmRelease.js'
const { actionNew, toEdit, actionDelete } = useHelmRelease();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'fluxcdHelmReleaseTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'fluxcdHelmReleaseTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'fluxcdHelmReleaseView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
