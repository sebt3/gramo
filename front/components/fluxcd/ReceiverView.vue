...
const { viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotReceiverFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useReceiver();setNamespacedItemFromRoute();
