...
import { ref, useBucket } from '../../libs/fluxcd/Bucket.js'
const { actionNew, toEdit, actionDelete } = useBucket();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'fluxcdBucketTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'fluxcdBucketTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'fluxcdBucketView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
