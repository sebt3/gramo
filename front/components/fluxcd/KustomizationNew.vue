...
import kustomizationNew from '@/queries/fluxcd/KustomizationNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'kustomizations.kustomize.toolkit.fluxcd.io'});
