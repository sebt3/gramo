...
import receiverNew from '@/queries/fluxcd/ReceiverNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'receivers.notification.toolkit.fluxcd.io'});
