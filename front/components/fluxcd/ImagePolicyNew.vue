...
import imagePolicyNew from '@/queries/fluxcd/ImagePolicyNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'imagepolicies.image.toolkit.fluxcd.io'});
