...
import { ref, useHelmChart } from '../../libs/fluxcd/HelmChart.js'
const { actionNew, toEdit, actionDelete } = useHelmChart();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'fluxcdHelmChartTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'fluxcdHelmChartTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'fluxcdHelmChartView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
