...
import { ref, useImagePolicy } from '../../libs/fluxcd/ImagePolicy.js'
const { actionNew, toEdit, actionDelete } = useImagePolicy();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'fluxcdImagePolicyTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'fluxcdImagePolicyTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'fluxcdImagePolicyView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
