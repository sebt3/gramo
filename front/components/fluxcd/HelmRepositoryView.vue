...
const { editor, viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotHelmRepositoryFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useHelmRepository();setNamespacedItemFromRoute();
