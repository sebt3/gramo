...
import helmRepositoryNew from '@/queries/fluxcd/HelmRepositoryNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'helmrepositories.source.toolkit.fluxcd.io'});
