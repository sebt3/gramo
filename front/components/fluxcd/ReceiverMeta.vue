...
import { ref, useReceiver } from '../../libs/fluxcd/Receiver.js'
const { actionNew, toEdit, actionDelete } = useReceiver();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'fluxcdReceiverTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'fluxcdReceiverTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'fluxcdReceiverView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
