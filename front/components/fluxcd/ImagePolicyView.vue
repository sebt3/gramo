...
const { editor, viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotImagePolicyFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useImagePolicy();setNamespacedItemFromRoute();
