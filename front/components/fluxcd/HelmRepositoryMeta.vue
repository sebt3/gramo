...
import { ref, useHelmRepository } from '../../libs/fluxcd/HelmRepository.js'
const { actionNew, toEdit, actionDelete } = useHelmRepository();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'fluxcdHelmRepositoryTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'fluxcdHelmRepositoryTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'fluxcdHelmRepositoryView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
