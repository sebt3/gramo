...
import { ref, useImageUpdateAutomation } from '../../libs/fluxcd/ImageUpdateAutomation.js'
const { actionNew, toEdit, actionDelete } = useImageUpdateAutomation();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'fluxcdImageUpdateAutomationTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'fluxcdImageUpdateAutomationTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'fluxcdImageUpdateAutomationView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
