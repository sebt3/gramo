...
import { ref, useAlert } from '../../libs/fluxcd/Alert.js'
const { actionNew, toEdit, actionDelete } = useAlert();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'fluxcdAlertTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'fluxcdAlertTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'fluxcdAlertView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
