...
import helmChartNew from '@/queries/fluxcd/HelmChartNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'helmcharts.source.toolkit.fluxcd.io'});
