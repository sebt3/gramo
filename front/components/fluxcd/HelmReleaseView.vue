...
const { editor, viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotHelmReleaseFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useHelmRelease();setNamespacedItemFromRoute();
