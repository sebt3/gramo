...
import imageUpdateAutomationNew from '@/queries/fluxcd/ImageUpdateAutomationNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'imageupdateautomations.image.toolkit.fluxcd.io'});
