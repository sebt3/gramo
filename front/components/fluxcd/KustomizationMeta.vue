...
import { ref, useKustomization } from '../../libs/fluxcd/Kustomization.js'
const { actionNew, toEdit, actionDelete } = useKustomization();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'fluxcdKustomizationTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'fluxcdKustomizationTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'fluxcdKustomizationView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
