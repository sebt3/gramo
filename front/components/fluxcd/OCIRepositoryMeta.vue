...
import { ref, useOCIRepository } from '../../libs/fluxcd/OCIRepository.js'
const { actionNew, toEdit, actionDelete } = useOCIRepository();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'fluxcdOCIRepositoryTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'fluxcdOCIRepositoryTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'fluxcdOCIRepositoryView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
