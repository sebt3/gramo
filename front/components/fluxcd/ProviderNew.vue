...
import providerNew from '@/queries/fluxcd/ProviderNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'providers.notification.toolkit.fluxcd.io'});
