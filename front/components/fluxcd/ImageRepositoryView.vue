...
const { viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotImageRepositoryFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useImageRepository();setNamespacedItemFromRoute();
