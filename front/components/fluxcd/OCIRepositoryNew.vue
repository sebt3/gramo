...
import oCIRepositoryNew from '@/queries/fluxcd/OCIRepositoryNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'ocirepositories.source.toolkit.fluxcd.io'});
