...
import { ref, useGitRepository } from '../../libs/fluxcd/GitRepository.js'
const { actionNew, toEdit, actionDelete } = useGitRepository();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'fluxcdGitRepositoryTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'fluxcdGitRepositoryTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'fluxcdGitRepositoryView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
