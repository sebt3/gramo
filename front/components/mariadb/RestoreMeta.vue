...
import { ref, useRestore } from '../../libs/mariadb/Restore.js'
const { actionNew, toEdit, actionDelete } = useRestore();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'mariadbRestoreTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'mariadbRestoreTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'mariadbRestoreView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
