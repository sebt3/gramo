...
import { ref, useSqlJob } from '../../libs/mariadb/SqlJob.js'
const { actionNew, toEdit, actionDelete } = useSqlJob();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'mariadbSqlJobTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'mariadbSqlJobTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'mariadbSqlJobView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
