...
import { ref, useGrant } from '../../libs/mariadb/Grant.js'
const { actionNew, toEdit, actionDelete } = useGrant();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'mariadbGrantTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'mariadbGrantTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'mariadbGrantView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
