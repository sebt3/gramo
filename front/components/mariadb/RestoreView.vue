...
const { result, loading, onResult, onError } = useQuery(mariadbRestoreQuery, {"namespace": navigation.currentNamespace, "name": navigation.currentItem }, { pollInterval: 500 });onError(onErrorHandler); onResult(onNotRestoreFound);
