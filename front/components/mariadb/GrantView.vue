...
const { result, loading, onResult, onError } = useQuery(mariadbGrantQuery, {"namespace": navigation.currentNamespace, "name": navigation.currentItem }, { pollInterval: 500 });onError(onErrorHandler); onResult(res => {onNotGrantFound(res);viewerUpdate(res, res.data.mariadbGrant.metadata.obj)});
