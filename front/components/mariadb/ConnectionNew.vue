...
import connectionNew from '@/queries/mariadb/ConnectionNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'connections.mariadb.mmontes.io'});
