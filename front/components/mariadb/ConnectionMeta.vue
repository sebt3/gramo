...
import { ref, useConnection } from '../../libs/mariadb/Connection.js'
const { actionNew, toEdit, actionDelete } = useConnection();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'mariadbConnectionTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'mariadbConnectionTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'mariadbConnectionView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
