...
import { ref, useUser } from '../../libs/mariadb/User.js'
const { actionNew, toEdit, actionDelete } = useUser();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'mariadbUserTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'mariadbUserTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'mariadbUserView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
