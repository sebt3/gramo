...
const { editor, viewer, viewerUpdate, onErrorHandler, notifySuccess, notifyError, onNotMariaDBFound, navigation, setNamespacedItemFromRoute, toEdit, actionDelete } = useMariaDB();setNamespacedItemFromRoute();
