...
import { ref, useMariaDB } from '../../libs/mariadb/MariaDB.js'
const { actionNew, toEdit, actionDelete } = useMariaDB();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'mariadbMariaDBTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'mariadbMariaDBTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'mariadbMariaDBView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
