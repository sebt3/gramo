...
import { ref, useDatabase } from '../../libs/mariadb/Database.js'
const { actionNew, toEdit, actionDelete } = useDatabase();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'mariadbDatabaseTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'mariadbDatabaseTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'mariadbDatabaseView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
