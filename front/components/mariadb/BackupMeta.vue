...
import { ref, useBackup } from '../../libs/mariadb/Backup.js'
const { actionNew, toEdit, actionDelete } = useBackup();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'mariadbBackupTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'mariadbBackupTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'mariadbBackupView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
