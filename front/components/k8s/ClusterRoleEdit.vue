...
const { onlyReadProperties, editor, setItemFromRoute } = useClusterRole();setItemFromRoute();
    ...
    <q-tab-panels v-model="editor.tab" animated>
      <q-tab-panel name="simple">
        <OpenApiEdit
          ...
          @update:out="(v)=>editor.setkey('aggregationRule', v)"
      ...
      <q-tab-panel name="yaml">
          <MonacoEditor
            ...
            :properties="getProperties({properties: Object.fromEntries(Object.entries(ClusterRoleDefinition).filter(([n])=>!['metadata','status'].includes(n)))})"
            />
      </q-tab-panel>
    </q-tab-panels>
  </q-card>
