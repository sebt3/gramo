...
import { ref, useStorageClass } from '../../libs/k8s/StorageClass.js'
const { actionNew, toEdit, actionDelete } = useStorageClass();
const to=ref({})
...
<template>
  <q-card bordered class="q-ma-sm">
    <q-card-section class="bg-primary text-grey-4">
      <div class="text-h6 q-mt-none q-mb-none q-pt-none q-pb-none">StorageClass
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'k8sStorageClassTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'k8sStorageClassTable', params: {  } }"
        :nameTo="{ name: 'k8sStorageClassView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
