...
import { useServiceAccount, getProperties, ServiceAccountDefinition } from '../../libs/k8s/ServiceAccount.js'
const { onlyReadProperties, viewer, viewerUpdate, setNamespacedItemFromRoute } = useServiceAccount();setNamespacedItemFromRoute();
