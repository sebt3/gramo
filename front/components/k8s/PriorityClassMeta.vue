...
import { ref, usePriorityClass } from '../../libs/k8s/PriorityClass.js'
const { actionNew, toEdit, actionDelete } = usePriorityClass();
const to=ref({})
...
<template>
  <q-card bordered class="q-ma-sm">
    <q-card-section class="bg-primary text-grey-4">
      <div class="text-h6 q-mt-none q-mb-none q-pt-none q-pb-none">PriorityClass
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'k8sPriorityClassTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'k8sPriorityClassTable', params: {  } }"
        :nameTo="{ name: 'k8sPriorityClassView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
