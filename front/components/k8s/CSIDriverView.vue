...
import { useCSIDriver, getProperties, CSIDriverDefinition } from '../../libs/k8s/CSIDriver.js'
const { onlyReadProperties, viewer, viewerUpdate, setItemFromRoute } = useCSIDriver();setItemFromRoute();
