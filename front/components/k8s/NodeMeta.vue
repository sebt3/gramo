...
import { ref, useNode } from '../../libs/k8s/Node.js'
const { actionNew, toEdit, actionDelete } = useNode();
const to=ref({})
...
<template>
  <q-card bordered class="q-ma-sm">
    <q-card-section class="bg-primary text-grey-4">
      <div class="text-h6 q-mt-none q-mb-none q-pt-none q-pb-none">Node
    ...
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'k8sNodeTable', params: {  } }"
        :nameTo="{ name: 'k8sNodeView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
