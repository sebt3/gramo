...
import { useEndpoints, getProperties, EndpointsDefinition } from '../../libs/k8s/Endpoints.js'
const { onlyReadProperties, viewer, viewerUpdate, setNamespacedItemFromRoute } = useEndpoints();setNamespacedItemFromRoute();
