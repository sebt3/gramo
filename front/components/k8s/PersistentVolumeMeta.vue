...
import { ref, usePersistentVolume } from '../../libs/k8s/PersistentVolume.js'
const { actionNew, toEdit, actionDelete } = usePersistentVolume();
const to=ref({})
...
<template>
  <q-card bordered class="q-ma-sm">
    <q-card-section class="bg-primary text-grey-4">
      <div class="text-h6 q-mt-none q-mb-none q-pt-none q-pb-none">PersistentVolume
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'k8sPersistentVolumeTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'k8sPersistentVolumeTable', params: {  } }"
        :nameTo="{ name: 'k8sPersistentVolumeView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
