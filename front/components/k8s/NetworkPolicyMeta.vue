...
import { ref, useNetworkPolicy } from '../../libs/k8s/NetworkPolicy.js'
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'k8sNetworkPolicyTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'k8sNetworkPolicyTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'k8sNetworkPolicyView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
