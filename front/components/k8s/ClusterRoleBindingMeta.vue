...
import { ref, useClusterRoleBinding } from '../../libs/k8s/ClusterRoleBinding.js'
const { actionNew, toEdit, actionDelete } = useClusterRoleBinding();
const to=ref({})
...
<template>
  <q-card bordered class="q-ma-sm">
    <q-card-section class="bg-primary text-grey-4">
      <div class="text-h6 q-mt-none q-mb-none q-pt-none q-pb-none">ClusterRoleBinding
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'k8sClusterRoleBindingTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'k8sClusterRoleBindingTable', params: {  } }"
        :nameTo="{ name: 'k8sClusterRoleBindingView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
