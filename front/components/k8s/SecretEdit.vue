...
const { onlyReadProperties, editor, setNamespacedItemFromRoute } = useSecret();setNamespacedItemFromRoute();
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-tab-panels v-model="editor.tab" animated>
      <q-tab-panel name="simple">
        ...
        <OpenApiEdit
          :in="model['stringData']"
          @update:out="(v)=>editor.setkey('stringData', v)"
      ...
      <q-tab-panel name="yaml">
          <MonacoEditor
            ...
            :properties="getProperties({properties: Object.fromEntries(Object.entries(SecretDefinition).filter(([n])=>!['metadata','status'].includes(n)))})"
            />
      </q-tab-panel>
    </q-tab-panels>
  </q-card>
