...
const { onlyReadProperties, editor, setNamespacedItemFromRoute } = useRole();setNamespacedItemFromRoute();
    ...
    <q-tab-panels v-model="editor.tab" animated>
      ...
      <q-tab-panel name="yaml">
          <MonacoEditor
            ...
            :properties="getProperties({properties: Object.fromEntries(Object.entries(RoleDefinition).filter(([n])=>!['metadata','status'].includes(n)))})"
            />
      </q-tab-panel>
    </q-tab-panels>
  </q-card>
