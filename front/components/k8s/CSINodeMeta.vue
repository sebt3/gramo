...
import { ref, useCSINode } from '../../libs/k8s/CSINode.js'
const { actionNew, toEdit, actionDelete } = useCSINode();
const to=ref({})
...
<template>
  <q-card bordered class="q-ma-sm">
    <q-card-section class="bg-primary text-grey-4">
      <div class="text-h6 q-mt-none q-mb-none q-pt-none q-pb-none">CSINode
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'k8sCSINodeTable', params: {  } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'k8sCSINodeTable', params: {  } }"
        :nameTo="{ name: 'k8sCSINodeView', params: {  name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
