...
const { onlyReadProperties, editor, setItemFromRoute } = useStorageClass();setItemFromRoute();
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-tab-panels v-model="editor.tab" animated>
      <q-tab-panel name="simple">
        <OpenApiEdit
          :in="model['parameters']"
          @update:out="(v)=>editor.setkey('parameters', v)"
      ...
      <q-tab-panel name="yaml">
          <MonacoEditor
            ...
            :properties="getProperties({properties: Object.fromEntries(Object.entries(StorageClassDefinition).filter(([n])=>!['metadata','status'].includes(n)))})"
            />
      </q-tab-panel>
    </q-tab-panels>
  </q-card>
