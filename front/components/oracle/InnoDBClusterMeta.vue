...
import { ref, useInnoDBCluster } from '../../libs/oracle/InnoDBCluster.js'
const { actionNew, toEdit, actionDelete } = useInnoDBCluster();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'oracleInnoDBClusterTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'oracleInnoDBClusterTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'oracleInnoDBClusterView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
