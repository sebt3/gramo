...
import { ref, useMySQLBackup } from '../../libs/oracle/MySQLBackup.js'
const { actionNew, toEdit, actionDelete } = useMySQLBackup();
const to=ref({})
  ...
  <q-card bordered class="q-ma-sm">
    ...
    <q-card-section  v-if="useActions">
      <MetadataView
        ...
        :to="{ name: 'oracleMySQLBackupTable', params: { namespace: model.metadata.namespace } }"
        />
    </q-card-section>
    <q-card-section  v-else>
      <MetadataView
        :metadata="model.metadata"
        :to="{ name: 'oracleMySQLBackupTable', params: { namespace: model.metadata.namespace } }"
        :nameTo="{ name: 'oracleMySQLBackupView', params: { namespace: model.metadata.namespace, name: model.metadata.name } }"
        />
    </q-card-section>
  </q-card>
</template>
