...
import scheduledBackupNew from '@/queries/postgresql/ScheduledBackupNew.graphql'
...
const { result, loading } = useQuery(customResourceDefinition, {"name": 'scheduledbackups.postgresql.cnpg.io'});
