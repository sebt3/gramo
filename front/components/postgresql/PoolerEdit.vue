...
onError(onErrorHandler);onResult(res => {onNotPoolerFound(res);editor.value.updateFromQuery(res, res.loading?{}:{spec: res.data.postgresqlPooler.metadata.obj.spec})});onPatchPooler(patchDone);onPatchError(patchError);
</script>
<template>
  ...
  <q-form @submit="onSubmit" class="q-gutter-md q-pt-sm q-ml-sm">
    <q-card bordered v-if="!loading && editor.ready && result.postgresqlPooler!=null" class="q-ma-sm">
