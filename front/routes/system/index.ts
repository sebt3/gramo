...
if (crds['backups.k8up.io'] != undefined) {
  linkRedirect.path = k8upRoute['redirect']!=undefined?k8upRoute['redirect'].path:'/system/k8up'
...
if (crds['prometheusrules.monitoring.coreos.com'] != undefined) {
  linkRedirect.path = monitoringRoute['redirect']!=undefined?monitoringRoute['redirect'].path:'/system/monitoring'
