...
export const iconNode = 'album';
export const colorNode = '';
export const descriptionNode = '';
export const shortNode = '';
export const iconPersistentVolume = 'album';
export const colorPersistentVolume = '';
export const descriptionPersistentVolume = '';
export const shortPersistentVolume = '';
export const iconPersistentVolumeClaim = 'album';
export const colorPersistentVolumeClaim = '';
export const descriptionPersistentVolumeClaim = '';
export const shortPersistentVolumeClaim = '';
export const iconPod = 'album';
export const colorPod = '';
export const descriptionPod = '';
export const shortPod = '';
export const iconPodTemplate = 'album';
export const colorPodTemplate = '';
export const descriptionPodTemplate = '';
export const shortPodTemplate = '';
export const iconReplicationController = 'album';
export const colorReplicationController = '';
export const descriptionReplicationController = '';
export const shortReplicationController = '';
export const iconResourceQuota = 'album';
export const colorResourceQuota = '';
export const descriptionResourceQuota = '';
export const shortResourceQuota = '';
export const iconSecret = 'key';
export const colorSecret = '';
export const descriptionSecret = '';
export const shortSecret = '';
export const iconService = 'album';
export const colorService = '';
export const descriptionService = '';
export const shortService = '';
export const iconServiceAccount = 'album';
export const colorServiceAccount = '';
export const descriptionServiceAccount = '';
export const shortServiceAccount = '';
export const iconAPIService = 'album';
...
export const shortDaemonSet = '';
export const iconDeployment = 'album';
export const colorDeployment = '';
export const descriptionDeployment = '';
export const shortDeployment = '';
export const iconReplicaSet = 'album';
export const colorReplicaSet = '';
export const descriptionReplicaSet = '';
export const shortReplicaSet = '';
export const iconStatefulSet = 'album';
export const colorStatefulSet = '';
export const descriptionStatefulSet = '';
export const shortStatefulSet = '';
export const iconHorizontalPodAutoscaler = 'album';
export const colorHorizontalPodAutoscaler = '';
export const descriptionHorizontalPodAutoscaler = '';
export const shortHorizontalPodAutoscaler = '';
export const iconJob = 'album';
export const colorJob = '';
export const descriptionJob = '';
export const shortJob = '';
export const iconCronJob = 'album';
export const colorCronJob = '';
export const descriptionCronJob = '';
export const shortCronJob = '';
export const iconCertificateSigningRequest = 'album';
export const colorCertificateSigningRequest = '';
export const descriptionCertificateSigningRequest = '';
export const shortCertificateSigningRequest = '';
export const iconIngress = 'album';
export const colorIngress = '';
export const descriptionIngress = '';
export const shortIngress = '';
export const iconNetworkPolicy = 'album';
export const colorNetworkPolicy = '';
export const descriptionNetworkPolicy = '';
export const shortNetworkPolicy = '';
export const iconPodDisruptionBudget = 'album';
export const colorPodDisruptionBudget = '';
export const descriptionPodDisruptionBudget = '';
export const shortPodDisruptionBudget = '';
export const iconRole = 'album';
export const colorRole = '';
export const descriptionRole = '';
export const shortRole = '';
export const iconClusterRoleBinding = 'album';
export const colorClusterRoleBinding = '';
export const descriptionClusterRoleBinding = '';
export const shortClusterRoleBinding = '';
export const iconRoleBinding = 'album';
export const colorRoleBinding = '';
export const descriptionRoleBinding = '';
export const shortRoleBinding = '';
export const iconClusterRole = 'album';
export const colorClusterRole = '';
export const descriptionClusterRole = '';
export const shortClusterRole = '';
export const iconStorageClass = 'album';
export const colorStorageClass = '';
export const descriptionStorageClass = '';
export const shortStorageClass = '';
export const iconCSIDriver = 'album';
export const colorCSIDriver = '';
export const descriptionCSIDriver = '';
export const shortCSIDriver = '';
export const iconCSINode = 'album';
export const colorCSINode = '';
export const descriptionCSINode = '';
export const shortCSINode = '';
export const iconCSIStorageCapacity = 'album';
export const colorCSIStorageCapacity = '';
export const descriptionCSIStorageCapacity = '';
export const shortCSIStorageCapacity = '';
export const iconVolumeAttachment = 'album';
export const colorVolumeAttachment = '';
export const descriptionVolumeAttachment = '';
export const shortVolumeAttachment = '';
export const iconMutatingWebhookConfiguration = 'album';
export const colorMutatingWebhookConfiguration = '';
export const descriptionMutatingWebhookConfiguration = '';
export const shortMutatingWebhookConfiguration = '';
export const iconValidatingWebhookConfiguration = 'album';
export const colorValidatingWebhookConfiguration = '';
export const descriptionValidatingWebhookConfiguration = '';
export const shortValidatingWebhookConfiguration = '';
export const iconCustomResourceDefinition = 'album';
export const colorCustomResourceDefinition = '';
export const descriptionCustomResourceDefinition = '';
export const shortCustomResourceDefinition = '';
export const iconPriorityClass = 'album';
export const colorPriorityClass = '';
export const descriptionPriorityClass = '';
export const shortPriorityClass = '';
export const iconLease = 'album';
export const colorLease = '';
export const descriptionLease = '';
export const shortLease = '';
export const iconRuntimeClass = 'album';
export const colorRuntimeClass = '';
export const descriptionRuntimeClass = '';
export const shortRuntimeClass = '';
export const iconEndpointSlice = 'album';
export const colorEndpointSlice = '';
export const descriptionEndpointSlice = '';
export const shortEndpointSlice = '';
