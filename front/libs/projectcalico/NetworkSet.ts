...
export { NetworkSetListExcludes, NetworkSetReadExcludes, NetworkSetSimpleExcludes } from './custom.js'
import { extraNetworkSetColumns } from './custom.js'
import { stringify, parse } from 'yaml'

export const NetworkSetColumns:Array<QTableColumn> = ([
  {name: 'Name', label: 'Name', field: row => row.metadata.name, sortable: true, align: tableColumnAlign.left}
] as Array<QTableColumn>).concat(extraNetworkSetColumns).concat([
...
export const NetworkSetDefinition = {"description":"NetworkSet is the Namespaced-equivalent of the GlobalNetworkSet.","type":"object","properties":{"apiVersion":{"description":"APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources","type":"string"},"kind":{"description":"Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds","type":"string"},"spec":{"description":"NetworkSetSpec contains the specification for a NetworkSet resource.","type":"object","properties":{"nets":{"description":"The list of IP networks that belong to this set.","type":"array","items":{"type":"string"}}}}},"x-kubernetes-group-version-kind":[{"group":"crd.projectcalico.org","kind":"NetworkSet","version":"v1"}]};
...
export function useNetworkSet() {
  ...
  return {
    ...
    if ( !res.loading && res.data.k8sNamespace[0].projectcalicoNetworkSet == null) {
    ...
    actionDelete: (deletor, meta) => {
      $q.dialog({
        ...
        message: `<em>You are</em> about to <span class="text-red">delete</span> NetworkSet <strong>${meta.name}</strong>`,
