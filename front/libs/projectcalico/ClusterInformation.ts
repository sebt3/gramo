  ...
  return {
    ...
    actionDelete: (deletor, meta) => {
      $q.dialog({
        ...
        message: `<em>You are</em> about to <span class="text-red">delete</span> ClusterInformation <strong>${meta.name}</strong>`,
