...
import IPAMBlockNew from '@/queries/projectcalico/IPAMBlock.create.graphql'
import OpenApiEdit from '@/components/core/OpenApiEdit.vue';
import MetadataNew from '@/components/core/MetadataNew.vue';
import { ref, useQuery, useMutation, useIPAMBlock, IPAMBlockDefinition, sanitizeData, getProperties } from '@/libs/projectcalico/IPAMBlock.js'
const name = ref('');
const spec  = ref({});
const { router, navigation, setItemFromRoute, notifySuccess, notifyError, notifyWorking } = useIPAMBlock();setItemFromRoute();
const { mutate, onDone, onError } = useMutation(IPAMBlockNew);
onDone(() => {
