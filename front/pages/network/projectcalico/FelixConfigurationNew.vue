...
import FelixConfigurationNew from '@/queries/projectcalico/FelixConfiguration.create.graphql'
import OpenApiEdit from '@/components/core/OpenApiEdit.vue';
import MetadataNew from '@/components/core/MetadataNew.vue';
import { ref, useQuery, useMutation, useFelixConfiguration, FelixConfigurationDefinition, sanitizeData, getProperties } from '@/libs/projectcalico/FelixConfiguration.js'
const name = ref('');
const spec  = ref({});
