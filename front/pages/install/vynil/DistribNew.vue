...
import DistribNew from '@/queries/vynil/Distrib.create.graphql'
import OpenApiEdit from '@/components/core/OpenApiEdit.vue';
import MetadataNew from '@/components/core/MetadataNew.vue';
import { ref, useQuery, useMutation, useDistrib, DistribDefinition, sanitizeData, getProperties } from '@/libs/vynil/Distrib.js'
const name = ref('');
const spec  = ref({});
const { router, navigation, setItemFromRoute, notifySuccess, notifyError, notifyWorking } = useDistrib();setItemFromRoute();
  ...
  <q-form @submit="onSubmit" class="q-gutter-md q-pt-sm q-ml-sm">
    ...
    <q-card bordered class="q-ma-sm">
      ...
      <q-card-section>
        <OpenApiEdit
          v-model:out="spec"
          :properties="getProperties(DistribDefinition.properties.spec)"
        />
      </q-card-section>
      <q-card-actions>
