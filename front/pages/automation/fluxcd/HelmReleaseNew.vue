...
import HelmReleaseNew from '@/queries/fluxcd/HelmRelease.create.graphql'
import OpenApiEdit from '@/components/core/OpenApiEdit.vue';
import MetadataNew from '@/components/core/MetadataNew.vue';
import { ref, useQuery, useMutation, useHelmRelease, HelmReleaseDefinition, sanitizeData, getProperties } from '@/libs/fluxcd/HelmRelease.js'
const name = ref('');
const spec  = ref({});
