...
import GitRepositoryNew from '@/queries/fluxcd/GitRepository.create.graphql'
import OpenApiEdit from '@/components/core/OpenApiEdit.vue';
import MetadataNew from '@/components/core/MetadataNew.vue';
import { ref, useQuery, useMutation, useGitRepository, GitRepositoryDefinition, sanitizeData, getProperties } from '@/libs/fluxcd/GitRepository.js'
const name = ref('');
const spec  = ref({});
