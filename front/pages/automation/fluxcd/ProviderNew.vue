...
import ProviderNew from '@/queries/fluxcd/Provider.create.graphql'
import OpenApiEdit from '@/components/core/OpenApiEdit.vue';
import MetadataNew from '@/components/core/MetadataNew.vue';
import { ref, useQuery, useMutation, useProvider, ProviderDefinition, sanitizeData, getProperties } from '@/libs/fluxcd/Provider.js'
const name = ref('');
const spec  = ref({});
const { router, navigation, setNamespacedItemFromRoute, notifySuccess, notifyError, notifyWorking } = useProvider();setNamespacedItemFromRoute();
const { mutate, onDone, onError } = useMutation(ProviderNew);
onDone(() => {
